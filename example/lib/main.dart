...
class MyHomePageState extends State<MyHomePage> {
    ...
    return DefaultDropdownMenuController(
      ...
      children: <Widget>[
        ...
        Expanded(
          ...
          children: <Widget>[
            ListView(
              children: const <Widget>[Text("123123")],
            ),
            buildDropdownMenu()
          ],
        ))
  ...
  void _onTapHead(int index) {
    ...
    DropdownMenuController? controller = globalKey.currentContext == null
        ? null
    ...
    scrollController
        .animateTo(
            scrollController.offset +
                (renderObject?.semanticBounds.height ?? 0),
          ...
          items: [
            ...
            {"name": "ScrollView", "icon": Icons.list}
              ...
              .map((dynamic data) => BottomNavigationBarItem(
                  label: data["name"], icon: Icon(data["icon"])))
              .toList()),
    );
  }
}
